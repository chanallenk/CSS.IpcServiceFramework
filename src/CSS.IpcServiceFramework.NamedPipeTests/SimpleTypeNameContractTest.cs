...
using CSS.IpcServiceFramework.NamedPipeTests.Fixtures;
using CSS.IpcServiceFramework.Testing;
...
namespace CSS.IpcServiceFramework.NamedPipeTests
{
    /// <summary>
    ...
    /// </summary>
    /// <seealso cref="Xunit.IClassFixture{CSS.IpcServiceFramework.Testing.IpcApplicationFactory{CSS.IpcServiceFramework.NamedPipeTests.Fixtures.ITestService}}" />
